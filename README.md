...
- 镜像制作命令
```
docker build -t hub.c.163.com/cnpbimserver/crawler:d-0.0.1 .
```
- 启动容器
```
docker run -p 8888:8888 -it --rm --name crawler  hub.c.163.com/cnpbimserver/crawler-b:d-0.0.1
```
